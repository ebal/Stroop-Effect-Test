      ...
      <div class="entry-list">
        <div v-for="(entry, i) in reversedEntries" :key="i" class="entry-row">
          ...
          <span class="entry-meta">
            <template v-if="entry.boardCleared">{{ formatTime(entry.completionTime) }}</template>
            <template v-else>{{ entry.numbersRemaining }} left</template>
...
const { getHistory } = useNumberMatchStats()
